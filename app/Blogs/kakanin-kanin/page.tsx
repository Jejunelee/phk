    ...
    <div className="min-h-screen bg-[#F5F3EF]">
      <article className="pt-28 md:pt-36 pb-16 md:pb-24">
        <div className="max-w-3xl mx-auto px-5 md:px-6">
          ...
          <p className="text-[#996D33] font-medium mb-10">
          ...
          <aside className="mt-12 md:mt-16 bg-white rounded-2xl shadow-md p-5 md:p-8 flex flex-col sm:flex-row gap-5 md:gap-8 items-center sm:items-start">
            <div className="relative w-28 h-28 md:w-32 md:h-32 shrink-0 overflow-hidden rounded-full">
              <Image
                src={post.author.image}
                alt={post.author.name}
                fill
                sizes="128px"
                className="object-cover object-[42%_72%] scale-[1.28] origin-[42%_62%]"
              />
            </div>
            <div className="text-center sm:text-left">
              <p className="text-[#996D33] text-xs font-semibold uppercase tracking-wide mb-1">
                Written by
              </p>
              <h2 className="font-crimson text-2xl md:text-3xl text-[#2D2926] mb-3">
                {post.author.name}
              </h2>
              <p className="font-crimson text-[#2D2926]/80 text-base md:text-[18px] leading-relaxed">
                {post.author.bio}
              </p>
            </div>
          </aside>
