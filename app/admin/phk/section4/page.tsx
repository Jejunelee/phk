  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-gray-900">PHK Section 4 - Calendar of Events</h1>
        ...
        {activeTab === 'settings' && (
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <h2 className="text-xl font-semibold mb-4 text-gray-900">Section Settings</h2>
            
            <div className="space-y-4">
              {/* Section Title */}
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-800">Section Title</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-3 gap-4">
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-800">Text Color</label>
                  <input
                    type="color"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-800">Accent Color</label>
                  <input
                    type="color"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-800">Event Date Color</label>
                  <input
                    type="color"
              ...
              {/* Text Content */}
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-800">Intro Text</label>
                <textarea
              ...
              <div>
                <label className="block text-sm font-medium mb-1 text-gray-800">Slots Text</label>
                <textarea
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-800">Mobile</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-sm font-medium mb-1 text-gray-800">Quote</label>
                  <input
                    type="text"
              ...
              <div className="border-t pt-4 mt-4">
                <h3 className="text-lg font-medium mb-3 text-gray-900">Featured Image (Right Side)</h3>
                ...
                <p className="text-xs text-gray-600 mt-1">Recommended size: 500x500px or square, max 5MB</p>
              </div>

              {/* Background Image Upload */}
              <div className="border-t pt-4 mt-4">
                <h3 className="text-lg font-medium mb-3 text-gray-900">Background Image</h3>
                ...
                <p className="text-xs text-gray-600 mt-1">Recommended: 1920x1080px or larger, max 10MB</p>
              </div>
